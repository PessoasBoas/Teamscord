...
export type CallStageHandle = { toggleMute: () => Promise<void>; requestMute: (peerId: string) => Promise<void>; leave: () => Promise<void>; reannounce: () => Promise<void> };
...
function StreamMedia({ stream, kind, muted }: { stream: MediaStream; kind: "audio" | "video"; muted?: boolean }) {
...
export const CallStage = forwardRef<CallStageHandle, CallStageProps>(function CallStage({ groupId, channelId, localPeerId, signals, sharedState, deafened, muted, compact = false, onToggleDeafened, onMutedChange, onJoined, onLeft, onState, onError }, ref) {
