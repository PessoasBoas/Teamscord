      ...
      <div className="settings-layout">
        ...
        <div className="settings-content">
          {tab === "appearance" && <div className="preference-form">
            ...
            <div className="preference-section"><h3>Identidade visual</h3><p>Personalize a cor do seu perfil e dos controles em todos os grupos.</p><div className="color-preferences"><label>acento<input type="color" value={preferences.accent_color ?? "#5865f2"} onChange={(event) => update("accent_color", event.target.value)} /></label><label>avatar<input type="color" value={preferences.avatar_color ?? "#5865f2"} onChange={(event) => update("avatar_color", event.target.value)} /></label><div className="color-preview"><span style={{ background: preferences.avatar_color ?? "#5865f2" }}>VO</span><b style={{ color: preferences.accent_color ?? "#5865f2" }}>Seu perfil</b></div></div></div>
