...
O GitHub mantém a release publicada [v1.0.2](https://github.com/PessoasBoas/Teamscord/releases/tag/v1.0.2); a build `1.0.3` separa o relay dos peers de grupo durante sincronização.
