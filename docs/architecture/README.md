...
O GitHub mantém a release publicada [v1.0.3](https://github.com/PessoasBoas/Teamscord/releases/tag/v1.0.3); a build `1.0.4` também remove o relay da malha Gossipsub do grupo.
