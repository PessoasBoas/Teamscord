...
Esta pasta contém a documentação visual da versão 0.3.0. Cada diagrama tem duas formas:
...
O GitHub está publicado em main no commit 5a60a55, com a release [v0.3.0](https://github.com/PessoasBoas/Teamscord/releases/tag/v0.3.0) e os assets NSIS/checksum.
