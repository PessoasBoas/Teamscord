...
Esta pasta contém a documentação visual da versão 0.3.1. Cada diagrama tem duas formas:
...
O GitHub está publicado em main, com a release [v0.3.1](https://github.com/PessoasBoas/Teamscord/releases/tag/v0.3.1) e os assets NSIS/checksum.
